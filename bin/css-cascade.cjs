#!/usr/bin/env node
// Copyright (c) 2026 sv.junic. MIT License. v1.0.0
...
Exit codes:
  0  \u5DEE\u5206\u306A\u3057
  1  \u5DEE\u5206\u3042\u308A
  2  \u30A8\u30E9\u30FC`,fs;try{fs=(0,us.parseArgs)({options:{format:{type:"string",default:"text"},filter:{type:"string",default:"changed"},"order-risk":{type:"boolean",default:!1},"ignore-cosmetic":{type:"boolean",default:!1},"semantic-selectors":{type:"boolean",default:!1},"no-color":{type:"boolean",default:!1},version:{type:"boolean",short:"v",default:!1},help:{type:"boolean",short:"h",default:!1}},allowPositionals:!0,args:process.argv.slice(2)})}catch(s){console.error(`Error: ${s.message}`),process.exit(2)}var{values:P,positionals:hs}=fs;P.version&&(console.log("1.0.0"),process.exit(0));P.help&&(console.log(cs),process.exit(0));hs.length<2&&(console.error(`Error: 2\u3064\u306E\u30D5\u30A1\u30A4\u30EB\u30D1\u30B9\u304C\u5FC5\u8981\u3067\u3059
